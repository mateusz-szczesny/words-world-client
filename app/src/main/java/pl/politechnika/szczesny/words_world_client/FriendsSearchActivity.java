...
public class FriendsSearchActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final UserViewModel userRelationViewModel = ViewModelProviders.of(this).get(UserViewModel.class);
        ...
        _search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userRelationViewModel.refreshData(getApplication(), searchText);
            }
        });
    }
}
